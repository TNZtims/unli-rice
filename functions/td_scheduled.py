...
def td_job(job_label, td_toggle):
...
def initiate_cron_jobs(schedule):
  ...
  for item in schedule:
    if item['enabled']:
      ...
      scheduler.add_job(td_job, 'cron', args=[item['label'], item['toggle']], id=item['label'],  hour=hour, minute=minute, second=second)
